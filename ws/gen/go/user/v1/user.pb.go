// /workspaces/gocline/ws/proto/user/v1/user.proto
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\vUserService\x12E\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponseB{\n" +
	"\vcom.user.v1B\tUserProtoP\x01Z$gocline.com/ws/gen/go/user/v1;userv1\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\x06proto3"
